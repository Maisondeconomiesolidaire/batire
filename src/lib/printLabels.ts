 ...
 *
 * `window.print()` sur la page courante imprime la page courante : en-tête du
 * CRM, barre latérale, filtres — et le format retombe sur A4. On fabrique donc
 * un document minimal dans une iframe hors écran, avec sa propre règle
 * `@page`, et c'est CE document qu'on imprime : le format de l'étiquette est
...
/**
 * Marge blanche autour du code, en nombre de modules. La norme QR en impose 4 :
 * sans elle le code touche le bord de l'étiquette et les lecteurs peinent à en
 * trouver les repères.
 */
